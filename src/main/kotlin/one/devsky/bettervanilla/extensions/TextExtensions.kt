...
fun String.rgb() = RGBApi.toColoredMessage(this).translateColor()
...
fun Any?.adventureLegacyText() =
    LegacyComponentSerializer.builder().hexColors().extractUrls().build().deserializeOr("$this", Component.text("FAILED", NamedTextColor.RED))!!